...
public class TransactionFactory
{
		...
		throws Exception
	{
		...
		{
			retValue = new InsertTreeTransaction(cust);
		}
		else
		if (transType.equals("AddTreeType") == true)
		{
			retValue = new InsertTreeTypeTransaction(cust);
		}
		else
		if (transType.equals("UpdateTree") == true)
		{
			retValue = new TreeTransaction(cust);
		}
		else
		if (transType.equals("UpdateTreeType") == true)
		{
			retValue = new UpdateTreeTypeTransaction(cust);
		}
		else
		if (transType.equals("UpdateScout") == true)
		{
			retValue = new UpdateScoutTransaction(cust);
		}
		else
		...
		{
			retValue = new StartShiftTransaction(cust);
		}
		else
		if (transType.equals("EndShift") == true)
		{
			retValue = new EndShiftTransaction(cust);
		}
		return retValue;
	}
}
