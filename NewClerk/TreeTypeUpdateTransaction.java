...
public class TreeTypeUpdateTransaction extends Transaction {
	...
	public TreeTypeUpdateTransaction() {
		super();
	...
	protected Scene createView() {
		Scene currentScene = myViews.get("TreeTypeUpdateTransactionView");

		if (currentScene == null) {
			View newView = ViewFactory.createView("TreeTypeUpdateTransactionView", this);
			currentScene = new Scene(newView);
			myViews.put("TreeTypeUpdateTransactionView", currentScene);
		}
