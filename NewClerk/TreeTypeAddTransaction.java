...
public class TreeTypeAddTransaction extends Transaction {
	String updateStatusMessage;

	public TreeTypeAddTransaction() {
		super();
	}
	...
	protected Scene createView() {
		Scene currentScene = myViews.get("TreeTypeAddTransactionView");

		if (currentScene == null) {
			View newView = ViewFactory.createView("TreeTypeAddTransactionView", this);
			currentScene = new Scene(newView);
			myViews.put("TreeTypeAddTransactionView", currentScene);
		}
