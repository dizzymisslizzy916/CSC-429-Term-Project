...
public class UpdateTreeTypeTransaction extends Transaction {
    ...
    public void processTreeTypeBarcodePrefix(String barcodePrefix) {
        try {
            ...
            TreeTypeCollection.findTreeTypeWithBarcodePrefixLike(barcodePrefix);
   ...
   /* else
    ...
    public void stateChangeRequest(String key, Object value) {
        if (key.equals("DoYourJob") == true) {
            doYourJob();
        } else if (key.equals("barcodePrefixEntered") == true) {
            ...
            selectedTreeType = TreeTypeCollection.retrieve(barCode);
